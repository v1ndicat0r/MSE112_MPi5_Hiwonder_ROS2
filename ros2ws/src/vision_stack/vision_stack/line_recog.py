...
class LineRecog(Node):
    ...
    def green_callback(self, msg):
        ...
        lines_out.data = [self.x1_bestfit_green,self.y1_bestfit_green,self.x2_bestfit_green,self.y2_bestfit_green]
    ...
    def blue_callback(self, msg):
        ...
        lines_out.data = [self.x1_bestfit_blue,self.y1_bestfit_blue,self.x2_bestfit_blue,self.y2_bestfit_blue]
