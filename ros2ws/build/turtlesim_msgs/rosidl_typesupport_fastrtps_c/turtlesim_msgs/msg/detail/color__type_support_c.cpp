...
using _Color__ros_msg_type = turtlesim_msgs__msg__Color;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim_msgs
bool cdr_serialize_turtlesim_msgs__msg__Color(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim_msgs
bool cdr_deserialize_turtlesim_msgs__msg__Color(
  eprosima::fastcdr::Cdr & cdr,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim_msgs
size_t get_serialized_size_turtlesim_msgs__msg__Color(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim_msgs
size_t max_serialized_size_turtlesim_msgs__msg__Color(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtlesim_msgs__msg__Color;
    is_plain =
      (
      offsetof(DataType, b) +
      last_member_size
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim_msgs
bool cdr_serialize_key_turtlesim_msgs__msg__Color(
  const turtlesim_msgs__msg__Color * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: r
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim_msgs
size_t get_serialized_size_key_turtlesim_msgs__msg__Color(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Color__ros_msg_type * ros_message = static_cast<const _Color__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim_msgs
size_t max_serialized_size_key_turtlesim_msgs__msg__Color(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const turtlesim_msgs__msg__Color * ros_message = static_cast<const turtlesim_msgs__msg__Color *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_turtlesim_msgs__msg__Color(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  turtlesim_msgs__msg__Color * ros_message = static_cast<turtlesim_msgs__msg__Color *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_turtlesim_msgs__msg__Color(cdr, ros_message);
}

static uint32_t _Color__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_turtlesim_msgs__msg__Color(
...
static size_t _Color__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtlesim_msgs__msg__Color(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlesim_msgs, msg, Color)() {
