...
static const _TeleportAbsolute_Event_type_support_symbol_names_t _TeleportAbsolute_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlesim_msgs, srv, TeleportAbsolute_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlesim_msgs, srv, TeleportAbsolute_Event)),
  }
};
...
{
  return &::turtlesim_msgs::srv::rosidl_typesupport_cpp::TeleportAbsolute_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlesim_msgs, srv, TeleportAbsolute_Event)() {
  return get_message_type_support_handle<turtlesim_msgs::srv::TeleportAbsolute_Event>();
}
...
static const rosidl_service_type_support_t TeleportAbsolute_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<turtlesim_msgs::srv::TeleportAbsolute_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<turtlesim_msgs::srv::TeleportAbsolute_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<turtlesim_msgs::srv::TeleportAbsolute_Event>(),
