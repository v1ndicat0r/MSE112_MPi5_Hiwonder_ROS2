...
// functions for turtlesim_msgs::srv::Spawn_Request already declared above

// functions for turtlesim_msgs::srv::Spawn_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_turtlesim_msgs
cdr_serialize(
  const turtlesim_msgs::srv::Spawn_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtlesim_msgs::srv::Spawn_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        turtlesim_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_Spawn_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        turtlesim_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_Spawn_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtlesim_msgs::srv::Spawn_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        turtlesim_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_Spawn_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        turtlesim_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_Spawn_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const turtlesim_msgs::srv::Spawn_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<turtlesim_msgs::srv::Spawn_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &turtlesim_msgs::srv::typesupport_fastrtps_cpp::_Spawn_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlesim_msgs, srv, Spawn_Event)() {
  return &turtlesim_msgs::srv::typesupport_fastrtps_cpp::_Spawn_Event__handle;
}
...
static const rosidl_service_type_support_t _Spawn__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<turtlesim_msgs::srv::Spawn_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<turtlesim_msgs::srv::Spawn_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<turtlesim_msgs::srv::Spawn_Event>(),
