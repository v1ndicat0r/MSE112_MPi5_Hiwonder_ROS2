...
#[link(name = "turtlesim_msgs__rosidl_typesupport_c")]
extern "C" {
    fn rosidl_typesupport_c__get_action_type_support_handle__turtlesim_msgs__action__RotateAbsolute() -> *const std::ffi::c_void;
}

// Corresponds to turtlesim_msgs__action__RotateAbsolute
#[allow(missing_docs, non_camel_case_types)]
...
impl rosidl_runtime_rs::Action for RotateAbsolute {
  ...
  fn get_type_support() -> *const std::ffi::c_void {
    // SAFETY: No preconditions for this function.
    unsafe { rosidl_typesupport_c__get_action_type_support_handle__turtlesim_msgs__action__RotateAbsolute() }
  }
