...
class Metaclass_SetPen_Request(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
...
class SetPen_Request(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_SetPen_Request):
...
class Metaclass_SetPen_Response(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
...
class SetPen_Response(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_SetPen_Response):
...
class Metaclass_SetPen_Event(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
...
class SetPen_Event(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_SetPen_Event):
    ...
    def __init__(self, *,
                 ...
                 request: typing.Optional[collections.abc.Sequence[turtlesim_msgs.srv.SetPen_Request]] = None,  # noqa: E501
                 response: typing.Optional[collections.abc.Sequence[turtlesim_msgs.srv.SetPen_Response]] = None,  # noqa: E501
                 check_fields: typing.Optional[bool] = None) -> None:
        if check_fields is not None:
            self._check_fields = check_fields
        else:
    ...
    @builtins.property
    def request(self) -> typing.Annotated[typing.Any, list[turtlesim_msgs.srv.SetPen_Request]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'request'."""
        return self._request

    @request.setter
    def request(self, value: collections.abc.Sequence[turtlesim_msgs.srv.SetPen_Request]) -> None:
            ...
            if False:  # Done for templating alignment
                ...
                assert \
                    ((isinstance(value, collections.abc.Sequence) or
                     ...
                     True), \
                    "The 'request' field must be sequence with length <= 1 and each value of type 'SetPen_Request'"
    ...
    @builtins.property
    def response(self) -> typing.Annotated[typing.Any, list[turtlesim_msgs.srv.SetPen_Response]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'response'."""
        return self._response

    @response.setter
    def response(self, value: collections.abc.Sequence[turtlesim_msgs.srv.SetPen_Response]) -> None:
        if isinstance(value, collections.abc.Set):
            import warnings
            warnings.warn(
                'Using set or subclass of set is deprecated,'
            ...
            if False:  # Done for templating alignment
                ...
                assert \
                    ((isinstance(value, collections.abc.Sequence) or
                     ...
                     True), \
                    "The 'response' field must be sequence with length <= 1 and each value of type 'SetPen_Response'"
...
class Metaclass_SetPen(rosidl_pycommon.interface_base_classes.ServiceTypeSupportMeta):
...
class SetPen(rosidl_pycommon.interface_base_classes.BaseService[
    SetPen_Request,
    SetPen_Response
], metaclass=Metaclass_SetPen):
    Request: TypeAlias = SetPen_Request
    Response: TypeAlias = SetPen_Response
    Event: TypeAlias = SetPen_Event
