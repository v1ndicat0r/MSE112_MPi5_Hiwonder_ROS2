...
class Metaclass_Spawn_Request(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
...
class Spawn_Request(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_Spawn_Request):
...
class Metaclass_Spawn_Response(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
...
class Spawn_Response(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_Spawn_Response):
...
class Metaclass_Spawn_Event(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
...
class Spawn_Event(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_Spawn_Event):
    ...
    def __init__(self, *,
                 ...
                 request: typing.Optional[collections.abc.Sequence[turtlesim_msgs.srv.Spawn_Request]] = None,  # noqa: E501
                 response: typing.Optional[collections.abc.Sequence[turtlesim_msgs.srv.Spawn_Response]] = None,  # noqa: E501
                 check_fields: typing.Optional[bool] = None) -> None:
        if check_fields is not None:
            self._check_fields = check_fields
        else:
    ...
    @builtins.property
    def request(self) -> typing.Annotated[typing.Any, list[turtlesim_msgs.srv.Spawn_Request]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'request'."""
        return self._request

    @request.setter
    def request(self, value: collections.abc.Sequence[turtlesim_msgs.srv.Spawn_Request]) -> None:
            ...
            if False:  # Done for templating alignment
                ...
                assert \
                    ((isinstance(value, collections.abc.Sequence) or
                     ...
                     True), \
                    "The 'request' field must be sequence with length <= 1 and each value of type 'Spawn_Request'"
    ...
    @builtins.property
    def response(self) -> typing.Annotated[typing.Any, list[turtlesim_msgs.srv.Spawn_Response]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'response'."""
        return self._response

    @response.setter
    def response(self, value: collections.abc.Sequence[turtlesim_msgs.srv.Spawn_Response]) -> None:
        if isinstance(value, collections.abc.Set):
            import warnings
            warnings.warn(
                'Using set or subclass of set is deprecated,'
            ...
            if False:  # Done for templating alignment
                ...
                assert \
                    ((isinstance(value, collections.abc.Sequence) or
                     ...
                     True), \
                    "The 'response' field must be sequence with length <= 1 and each value of type 'Spawn_Response'"
...
class Metaclass_Spawn(rosidl_pycommon.interface_base_classes.ServiceTypeSupportMeta):
...
class Spawn(rosidl_pycommon.interface_base_classes.BaseService[
    Spawn_Request,
    Spawn_Response
], metaclass=Metaclass_Spawn):
    Request: TypeAlias = Spawn_Request
    Response: TypeAlias = Spawn_Response
    Event: TypeAlias = Spawn_Event
