...
class Metaclass_Kill_Request(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
...
class Kill_Request(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_Kill_Request):
...
class Metaclass_Kill_Response(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
...
class Kill_Response(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_Kill_Response):
...
class Metaclass_Kill_Event(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
...
class Kill_Event(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_Kill_Event):
    ...
    def __init__(self, *,
                 ...
                 request: typing.Optional[collections.abc.Sequence[turtlesim_msgs.srv.Kill_Request]] = None,  # noqa: E501
                 response: typing.Optional[collections.abc.Sequence[turtlesim_msgs.srv.Kill_Response]] = None,  # noqa: E501
                 check_fields: typing.Optional[bool] = None) -> None:
        if check_fields is not None:
            self._check_fields = check_fields
        else:
    ...
    @builtins.property
    def request(self) -> typing.Annotated[typing.Any, list[turtlesim_msgs.srv.Kill_Request]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'request'."""
        return self._request

    @request.setter
    def request(self, value: collections.abc.Sequence[turtlesim_msgs.srv.Kill_Request]) -> None:
            ...
            if False:  # Done for templating alignment
                ...
                assert \
                    ((isinstance(value, collections.abc.Sequence) or
                     ...
                     True), \
                    "The 'request' field must be sequence with length <= 1 and each value of type 'Kill_Request'"
    ...
    @builtins.property
    def response(self) -> typing.Annotated[typing.Any, list[turtlesim_msgs.srv.Kill_Response]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'response'."""
        return self._response

    @response.setter
    def response(self, value: collections.abc.Sequence[turtlesim_msgs.srv.Kill_Response]) -> None:
        if isinstance(value, collections.abc.Set):
            import warnings
            warnings.warn(
                'Using set or subclass of set is deprecated,'
            ...
            if False:  # Done for templating alignment
                ...
                assert \
                    ((isinstance(value, collections.abc.Sequence) or
                     ...
                     True), \
                    "The 'response' field must be sequence with length <= 1 and each value of type 'Kill_Response'"
...
class Metaclass_Kill(rosidl_pycommon.interface_base_classes.ServiceTypeSupportMeta):
...
class Kill(rosidl_pycommon.interface_base_classes.BaseService[
    Kill_Request,
    Kill_Response
], metaclass=Metaclass_Kill):
    Request: TypeAlias = Kill_Request
    Response: TypeAlias = Kill_Response
    Event: TypeAlias = Kill_Event
