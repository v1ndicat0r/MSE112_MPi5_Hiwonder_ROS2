...
class Metaclass_TeleportRelative_Request(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
...
class TeleportRelative_Request(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_TeleportRelative_Request):
...
class Metaclass_TeleportRelative_Response(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
...
class TeleportRelative_Response(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_TeleportRelative_Response):
...
class Metaclass_TeleportRelative_Event(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
...
class TeleportRelative_Event(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_TeleportRelative_Event):
    ...
    def __init__(self, *,
                 ...
                 request: typing.Optional[collections.abc.Sequence[turtlesim_msgs.srv.TeleportRelative_Request]] = None,  # noqa: E501
                 response: typing.Optional[collections.abc.Sequence[turtlesim_msgs.srv.TeleportRelative_Response]] = None,  # noqa: E501
                 check_fields: typing.Optional[bool] = None) -> None:
        if check_fields is not None:
            self._check_fields = check_fields
        else:
    ...
    @builtins.property
    def request(self) -> typing.Annotated[typing.Any, list[turtlesim_msgs.srv.TeleportRelative_Request]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'request'."""
        return self._request

    @request.setter
    def request(self, value: collections.abc.Sequence[turtlesim_msgs.srv.TeleportRelative_Request]) -> None:
            ...
            if False:  # Done for templating alignment
                ...
                assert \
                    ((isinstance(value, collections.abc.Sequence) or
                     ...
                     True), \
                    "The 'request' field must be sequence with length <= 1 and each value of type 'TeleportRelative_Request'"
    ...
    @builtins.property
    def response(self) -> typing.Annotated[typing.Any, list[turtlesim_msgs.srv.TeleportRelative_Response]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'response'."""
        return self._response

    @response.setter
    def response(self, value: collections.abc.Sequence[turtlesim_msgs.srv.TeleportRelative_Response]) -> None:
        if isinstance(value, collections.abc.Set):
            import warnings
            warnings.warn(
                'Using set or subclass of set is deprecated,'
            ...
            if False:  # Done for templating alignment
                ...
                assert \
                    ((isinstance(value, collections.abc.Sequence) or
                     ...
                     True), \
                    "The 'response' field must be sequence with length <= 1 and each value of type 'TeleportRelative_Response'"
...
class Metaclass_TeleportRelative(rosidl_pycommon.interface_base_classes.ServiceTypeSupportMeta):
...
class TeleportRelative(rosidl_pycommon.interface_base_classes.BaseService[
    TeleportRelative_Request,
    TeleportRelative_Response
], metaclass=Metaclass_TeleportRelative):
    Request: TypeAlias = TeleportRelative_Request
    Response: TypeAlias = TeleportRelative_Response
    Event: TypeAlias = TeleportRelative_Event
