...
enum
{
  turtlesim_msgs__action__RotateAbsolute_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  turtlesim_msgs__action__RotateAbsolute_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/RotateAbsolute in the package turtlesim_msgs.
typedef struct turtlesim_msgs__action__RotateAbsolute_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  turtlesim_msgs__action__RotateAbsolute_SendGoal_Request__Sequence request;
  turtlesim_msgs__action__RotateAbsolute_SendGoal_Response__Sequence response;
} turtlesim_msgs__action__RotateAbsolute_SendGoal_Event;

// Struct for a sequence of turtlesim_msgs__action__RotateAbsolute_SendGoal_Event.
typedef struct turtlesim_msgs__action__RotateAbsolute_SendGoal_Event__Sequence
{
...
enum
{
  turtlesim_msgs__action__RotateAbsolute_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  turtlesim_msgs__action__RotateAbsolute_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/RotateAbsolute in the package turtlesim_msgs.
typedef struct turtlesim_msgs__action__RotateAbsolute_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  turtlesim_msgs__action__RotateAbsolute_GetResult_Request__Sequence request;
  turtlesim_msgs__action__RotateAbsolute_GetResult_Response__Sequence response;
} turtlesim_msgs__action__RotateAbsolute_GetResult_Event;

// Struct for a sequence of turtlesim_msgs__action__RotateAbsolute_GetResult_Event.
typedef struct turtlesim_msgs__action__RotateAbsolute_GetResult_Event__Sequence
{
