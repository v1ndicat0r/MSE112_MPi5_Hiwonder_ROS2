...
enum
{
  turtlesim_msgs__srv__Kill_Event__request__MAX_SIZE = 1
};
// response
enum
{
  turtlesim_msgs__srv__Kill_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/Kill in the package turtlesim_msgs.
typedef struct turtlesim_msgs__srv__Kill_Event
{
  service_msgs__msg__ServiceEventInfo info;
  turtlesim_msgs__srv__Kill_Request__Sequence request;
  turtlesim_msgs__srv__Kill_Response__Sequence response;
} turtlesim_msgs__srv__Kill_Event;

// Struct for a sequence of turtlesim_msgs__srv__Kill_Event.
typedef struct turtlesim_msgs__srv__Kill_Event__Sequence
{
