...
bool turtlesim_msgs__msg__color__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("turtlesim_msgs.msg._color", (char *)PyUnicode_1BYTE_DATA(module_attr), 25) == 0);
  ...
  turtlesim_msgs__msg__Color * ros_message = _ros_message;
  {  // r
...
PyObject * turtlesim_msgs__msg__color__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("turtlesim_msgs.msg._color");
