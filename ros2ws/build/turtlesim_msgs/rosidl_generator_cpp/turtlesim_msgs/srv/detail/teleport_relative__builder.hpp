...
{
public:
  explicit Init_TeleportRelative_Event_response(::turtlesim_msgs::srv::TeleportRelative_Event & msg)
  : msg_(msg)
  {}
  ::turtlesim_msgs::srv::TeleportRelative_Event response(::turtlesim_msgs::srv::TeleportRelative_Event::_response_type arg)
  {
...
private:
  ::turtlesim_msgs::srv::TeleportRelative_Event msg_;
};

class Init_TeleportRelative_Event_request
{
public:
  explicit Init_TeleportRelative_Event_request(::turtlesim_msgs::srv::TeleportRelative_Event & msg)
  : msg_(msg)
  {}
  Init_TeleportRelative_Event_response request(::turtlesim_msgs::srv::TeleportRelative_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_TeleportRelative_Event_request info(::turtlesim_msgs::srv::TeleportRelative_Event::_info_type arg)
  {
...
template<>
inline
auto build<::turtlesim_msgs::srv::TeleportRelative_Event>()
{
  return turtlesim_msgs::srv::builder::Init_TeleportRelative_Event_info();
}
