...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, turtlesim_msgs::srv::Spawn_Request>, int> = 0>
...
template<>
constexpr const char * data_type<turtlesim_msgs::srv::Spawn_Request>()
{
  return "turtlesim_msgs::srv::Spawn_Request";
}

template<>
constexpr const char * name<turtlesim_msgs::srv::Spawn_Request>()
{
  return "turtlesim_msgs/srv/Spawn_Request";
}
...
template<>
struct MessageTraits<turtlesim_msgs::srv::Spawn_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, turtlesim_msgs::srv::Spawn_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<turtlesim_msgs::srv::Spawn_Response>()
{
  return "turtlesim_msgs::srv::Spawn_Response";
}

template<>
constexpr const char * name<turtlesim_msgs::srv::Spawn_Response>()
{
  return "turtlesim_msgs/srv/Spawn_Response";
}
...
template<>
struct MessageTraits<turtlesim_msgs::srv::Spawn_Response>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, turtlesim_msgs::srv::Spawn_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<turtlesim_msgs::srv::Spawn_Event>()
{
  return "turtlesim_msgs::srv::Spawn_Event";
}

template<>
constexpr const char * name<turtlesim_msgs::srv::Spawn_Event>()
{
  return "turtlesim_msgs/srv/Spawn_Event";
}

template<>
struct has_fixed_size<turtlesim_msgs::srv::Spawn_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<turtlesim_msgs::srv::Spawn_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<turtlesim_msgs::srv::Spawn_Request>::value && has_bounded_size<turtlesim_msgs::srv::Spawn_Response>::value> {};

template<>
struct is_message<turtlesim_msgs::srv::Spawn_Event>
  : std::true_type {};

template<>
struct MessageTraits<turtlesim_msgs::srv::Spawn_Event>
{
...
template<>
constexpr const char * data_type<turtlesim_msgs::srv::Spawn>()
{
  return "turtlesim_msgs::srv::Spawn";
}

template<>
constexpr const char * name<turtlesim_msgs::srv::Spawn>()
{
  return "turtlesim_msgs/srv/Spawn";
}
