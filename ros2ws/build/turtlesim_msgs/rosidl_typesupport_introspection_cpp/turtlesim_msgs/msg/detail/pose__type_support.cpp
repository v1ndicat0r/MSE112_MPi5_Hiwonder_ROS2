...
{
  new (message_memory) turtlesim_msgs::msg::Pose(_init);
}

void Pose_fini_function(void * message_memory)
{
  auto typed_message = static_cast<turtlesim_msgs::msg::Pose *>(message_memory);
  typed_message->~Pose();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Pose_message_member_array[5] = {
  {
    ...
    offsetof(turtlesim_msgs::msg::Pose, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtlesim_msgs::msg::Pose, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtlesim_msgs::msg::Pose, theta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtlesim_msgs::msg::Pose, linear_velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtlesim_msgs::msg::Pose, angular_velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Pose_message_members = {
  "turtlesim_msgs::msg",  // message namespace
  "Pose",  // message name
  5,  // number of fields
  sizeof(turtlesim_msgs::msg::Pose),
...
get_message_type_support_handle<turtlesim_msgs::msg::Pose>()
{
  return &::turtlesim_msgs::msg::rosidl_typesupport_introspection_cpp::Pose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlesim_msgs, msg, Pose)() {
  return &::turtlesim_msgs::msg::rosidl_typesupport_introspection_cpp::Pose_message_type_support_handle;
}
